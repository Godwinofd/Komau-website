    ...
    return (
        <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-6 text-center flex flex-col items-center justify-center h-full pt-20">
                ...
                <h1 className="text-6xl md:text-8xl lg:text-9xl font-heading font-bold text-white mb-8 tracking-tighter uppercase leading-[0.9] drop-shadow-2xl animate-fade-in-up opacity-0" style={{ animationDelay: '0.3s' }}>
                    Forged In <br />
                ...
                <p className="text-lg md:text-2xl text-text-secondary max-w-2xl mx-auto mb-12 font-light leading-relaxed animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.7s' }}>
                    <Link
                        href="#contact"
                        className="w-full sm:w-auto btn-primary px-10 py-5 rounded-full shadow-lg shadow-primary/20"
                    >
                        Start Free Trial
                    </Link>
                    <Link
                        href="#timetable"
                        className="w-full sm:w-auto btn-secondary px-10 py-5 rounded-full"
                    >
                        View Timetable
                    </Link>
                </div>
            ...
            {/* Scroll Indicator */}
            <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 animate-pulse-slow">
